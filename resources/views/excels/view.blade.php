                       ...
                       <input id="id" type="hidden" class="form-control" name="id"  value="<?php  echo $excel['id'];?>"/>
                        ...
                        <div class="form-group{{ $errors->has('titre') ? ' has-error' : '' }}">
                         ...
                         <label for="name" class="col-md-4 control-label">Fichier</label>
                            ...
                            <div class="col-md-6">
                                <input  autocomplete="off"  target="_blank" id="chemin" type="file" class="form-control" name="chemin"  required   accept="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel" >
 
                                         <a class="form-control" href="//<?php echo $_SERVER['HTTP_HOST'];?>/storage/excels/<?php echo $excel['chemin'];?>" > 
