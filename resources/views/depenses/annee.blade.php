 ...
 @section('content')
    ...
    <div class="uper">
        ...
        <div class="portlet box grey">
            <div class="row">
                <div class="col-lg-6"><h2>Liste des Dépenses - Année <?php echo  $annee; ?></h2></div>
			 <div class="col-lg-3">
             <div class="btn-group">
                ...
                <ul class="dropdown-menu pull-right">
                    <li style="text-align:center;width:120px">
                        <a href="{{route('depenses.annee',['annee'=>'2020' ])}}"  style="font-size:17px;height:25px;margin-bottom:3px;">
                            2020 </a>
                    </li>
                    <li style="text-align:center;width:120px">
                        <a href="{{route('depenses.annee',['annee'=>2021 ])}}"  style="font-size:17px;height:25px;margin-bottom:3px;">
                            2021 </a>
                    </li>
                    <li style="text-align:center;;width:120px">
                        <a href="{{route('depenses.annee',['annee'=>2022 ])}}"  style="font-size:17px;height:25px;margin-bottom:3px;">
                            2022 </a>
                    </li>
