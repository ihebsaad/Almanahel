...
<div class="row"  style="margin-left:10px">
    <div class="form-group">
      <div class="col-md-6">
       ...
       <input class="form-control" type="number" name="eleve" id="eleve"  onchange="changing(this)"  value="{{ $inscription->eleve }}" />
       </div>
       </div>
       </div>
<div class="row" style="margin-left:10px">
...
<div class="row" style="margin-left:10px">
    <div class="form-group">
      <div class="col-md-6">
       ...
       <input class="form-control" type="text" name="annee" id="annee" onchange="changing(this)"    value="{{ $inscription->annee }}" />
 </div>
    </div>
</div>
<div class="row" style="margin-left:10px">
...
<div class="row" style="margin-left:10px";>
  <div class="form-group">
      <div class="col-md-6">
       <label class="form-label" for="nomclub">Nom de Club : </label>
...
<div class="row" style="margin-left:15px">
    <div class="form-group">
      <div class="col-md-6">
       <label class="form-label" for="17h">17h15-18h30: </label>
...
<div class="row" style="margin-left:15px">
   <div class="form-group">
      <div class="col-md-6">
       <label class="form-label" for="12h">12h30-13h45 :  </label>
...
<div class="row"  style="margin-left:10px">
  <div class="form-group">
      <div class="col-md-6">
       ...
       <input class="form-control" type="number" name="civilite" id="civilite" onchange="changing(this)"  value="{{ $inscription-> civilite}}" />
       </div>
          </div>
             </div>
<div class="row" style="margin-left:10px">
