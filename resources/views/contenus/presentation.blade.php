...
<div class="form-group">
     {{ csrf_field() }}
<?php 
$contenu =  App\Contenu::where('zone', 'presentation')->pluck('contenu');
$contenu2 =  App\Contenu::where('zone', 'presentation2')->pluck('contenu');
$contenu3 =  App\Contenu::where('zone', 'presentation3')->pluck('contenu');
