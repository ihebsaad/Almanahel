...
@section('content')
    <style>
     ...
     <div class="portlet box grey">
            <div class="row">
                <div class="col-lg-6"><h2>Liste des excels finances - Année <?php echo $annee.'-'.$anneet?></h2></div>
            <div class="col-lg-3">
             <div class="btn-group">
 ...
 <li style="text-align:center;width:120px">
                        <a href="{{action('ExcelsController@annee', $anneep)}}"  style="font-size:17px;height:25px;margin-bottom:3px;">
                           <?php echo $anneep.'-'.$anneeac  ?> </a>
                    </li>
                    <li style="text-align:center;width:120px">
                        <a href="{{action('ExcelsController@annee', $anneeac)}}"  style="font-size:17px;height:25px;margin-bottom:3px;">
                           <?php echo $anneeac.'-'.$annees  ?> </a>
                    </li>
                    <li style="text-align:center;;width:120px">
                        <a href="{{action('ExcelsController@annee', $annees)}}"  style="font-size:17px;height:25px;margin-bottom:3px;">
