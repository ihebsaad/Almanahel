...
<div class="modal-body">
    ...
    <div class="row">
       ...
       <div class="form-group ">
                    ...
                    <div class="editor" >
                        <textarea style="min-height: 380px;"  id="scolaire" type="text"  class="textarea tex-com" placeholder="Contenu ici" name="home" required  ></textarea>
                    </div>
         </div>
	 ...
	 <div class="row">
       ...
       <div class="form-group ">
                    ...
                    <div class="editor" >
                        <textarea style="min-height: 380px;"  id="scolaire2" type="text"  class="textarea tex-com" placeholder="Contenu ici" name="home" required  ></textarea>
                    </div>
         </div>
