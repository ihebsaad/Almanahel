...
@section('content')
    ...
    <div class="portlet box grey">
            <div class="row">
                <div class="col-lg-9"><h2>Liste des Annonces</h2></div>
                <div class="col-lg-3">
                    <a   class="btn btn-md btn-success"    href="{{action('AnnoncesController@create')}}" ><b><i class="fas fa-plus"></i> Ajouter une annonce</b></a>
                </div>
            </div>
        </div>
        <table id="mytable" class="table table-striped" id="mytable" style="width:100%">
            ...
            @foreach($annonces as $annonce)
                ...
                <tr>
                    ...
                    <td style="width:20%" ><a href="{{action('AnnoncesController@view', $annonce['id'])}}" ><center><?php if($annonce->image==''){ ?> <img src="{{  URL::asset('public/site/img/no-image.png') }}" style="width:100px" /> <?php }else{  ?><img src="//<?php echo $_SERVER['HTTP_HOST'];?>/storage/images/<?php echo $annonce->image;?>" style="max-width:150px"/> <?php } ?></center> </a></td>
