...
@section('content')
    <style>
     ...
     <div class="portlet box grey">
            <div class="row">
                <div class="col-lg-6"><h2>Liste des Classes  - Année <?php echo $annee.'-'.$anneet?></h2></div>
                          <div class="col-lg-3">
             <div class="btn-group">
                   ...
                   <br/>
                    ...
                    <td>
                        <a  onclick="return confirm('Êtes-vous sûrs ?')"  href="{{action('ClassesController@destroy', $classe['id'])}}" class="btn btn-danger btn-sm btn-responsive " role="button" data-toggle="tooltip" data-tooltip="tooltip" data-placement="bottom" data-original-title="Supprimer" >
                         ...
                         <a   href="{{action('ClassesController@view', $classe['id'])}}"  class="btn btn-md btn-success"  role="button" data-toggle="tooltip" data-tooltip="tooltip" data-placement="bottom" data-original-title="Valider" >
